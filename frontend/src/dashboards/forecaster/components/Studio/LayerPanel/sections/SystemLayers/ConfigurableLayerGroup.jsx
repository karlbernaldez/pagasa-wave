...
import { ModelSelector, ElementSelector } from './LayerSelectors';
 ...
 *  - emoji         : string
 *  - title         : string
 *  - config        : { enabled, models, elements }
 ...
 *  - modelCols     : number (grid columns for model buttons, default 3)
 *  - isDarkMode    : boolean
 */
    ...
    <div className={`rounded-lg ${isDarkMode ? 'bg-white/5' : 'bg-black/5'}`}>
      ...
      {expanded && enabled && (
        <div className="px-2 pb-2 space-y-2">
          ...
          <ElementSelector
            elements={elements}
            value={getSelectedElement(config.elements, elements)}
