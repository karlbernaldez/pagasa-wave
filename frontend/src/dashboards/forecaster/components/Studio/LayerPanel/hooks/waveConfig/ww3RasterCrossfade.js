const SOURCE_PREFIX = 'ww3-crossfade-source-';
const LAYER_PREFIX = 'ww3-crossfade-layer-';
const SLOTS = ['a', 'b'];

export const WW3_CROSSFADE_MS = 450;
  ...
  map.addLayer(
    {
      ...
      paint: {
        ...
        'raster-opacity-transition': { duration: WW3_CROSSFADE_MS, delay: 0 },
...
export const removeWw3RasterCrossfade = (map) => {
  if (!map) return;
