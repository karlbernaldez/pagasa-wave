...
describe('resolveWW3ForecastRun', () => {
  ...
  it('uses explicit valid three-hour frames through T+60', () => {
    expect(resolveWW3ForecastRun({ forecastDate: '2026-09-01', forecastHour: 3 })).toMatchObject({
      forecastHour: 3,
      runDateTime: '2026083121',
    });
    expect(resolveWW3ForecastRun({ forecastDate: '2026-09-01', forecastHour: 60 })).toMatchObject({
      forecastHour: 60,
      runDateTime: '2026090306',
    });
  });
