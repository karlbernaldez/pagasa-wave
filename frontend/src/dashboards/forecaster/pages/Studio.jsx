...
const Studio = ({ logger }) => {
  ...
  return (
    <div className={`relative h-screen w-full overflow-hidden ${isDarkMode ? "bg-slate-950" : "bg-slate-100"}`}>
      ...
      {isCanvasActive && canUseEditingTools && <Canvas mapRef={mapRef} drawCounter={drawCounter} setDrawCounter={setDrawCounter} isDarkMode={isDarkMode} setLayersRef={setLayersRef} closedMode={closedMode} lineCount={lineCount} />}
      {isFlagCanvasActive && canUseEditingTools && <FlagCanvas mapRef={mapRef} isDarkMode={isDarkMode} setLayersRef={setLayersRef} />}
