...
const Studio = ({ logger }) => {
  ...
  return (
    <div className={`relative h-screen w-full overflow-hidden ${isDarkMode ? "bg-slate-950" : "bg-slate-100"}`}>
      ...
      {showMainUI && !isReadOnlyProject && <Canvas isCanvasActive={isCanvasActive} setIsCanvasActive={toggleCanvas} drawInstance={drawInstance} drawCounter={drawCounter} setDrawCounter={setDrawCounter} closedMode={closedMode} setClosedMode={setClosedMode} projectId={projectId} />}
      {showMainUI && !isReadOnlyProject && <FlagCanvas isCanvasActive={isFlagCanvasActive} setIsCanvasActive={toggleFlagCanvas} drawInstance={drawInstance} drawCounter={drawCounter} setDrawCounter={setDrawCounter} projectId={projectId} />}
