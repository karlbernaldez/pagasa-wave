...
function makeTheme(dark) {
  return {
    ...
    bannerBg: dark
      ? 'linear-gradient(135deg,#051428 0%,#071d3d 40%,#0a1f3f 60%,#060e1e 100%)'
    ...
    avatarBg: dark
      ? 'linear-gradient(135deg,#0f1e38,#1a2d4a)'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
      <label
        style={{
          ...
          color: readOnly ? t.iconReadOnly : t.textLabel,
          fontFamily: 'inherit',
        }}
      >
        {label}
      ...
      <div style={{ position: 'relative' }}>
        <div
          style={{
            ...
            color: readOnly ? t.iconReadOnly : focused ? t.iconFocusColor : t.iconColor,
      ...
      >
        <div
          style={{
            ...
            alignItems: 'center',
            gap: 8,
            borderBottom: `1px solid ${t.cardHeadBorder}`,
            background: t.cardHeadBg,
          }}
        >
          <div
            style={{
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (emailRequestNeeded) {
        setToast({
          message:
            'Profile saved. Verify the link sent to your new email before it becomes your login email.',
          type: 'success',
        });
      } else {
        ...
        <div
          style={{
            ...
            background: isDarkMode
              ? 'radial-gradient(ellipse 80% 60% at 50% 0%,#051428 0%,#020816 60%)'
              : 'radial-gradient(ellipse 80% 60% at 50% 0%,#dbeafe 0%,#f1f5f9 60%)',
          }}
        />
        <div
          style={{
            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-end', gap: 20 }}>
                <div style={{ position: 'relative' }}>
                  <div
                    style={{
                      ...
                      borderRadius: 26,
                      background:
                        'conic-gradient(from 180deg,rgba(56,189,248,0.5),transparent,rgba(56,189,248,0.2),transparent)',
                      filter: 'blur(4px)',
                    }}
                  />
                  <div
                  ...
                  >
                    <div
                      style={{
                        ...
                        justifyContent: 'center',
                        overflow: 'hidden',
                        boxShadow: `0 0 30px rgba(56,189,248,0.2),0 16px 48px rgba(0,0,0,${isDarkMode ? 0.6 : 0.12})`,
                      }}
                    >
                      {displayAvatar ? (
                        <img
                ...
                <div style={{ paddingBottom: 4 }}>
                  <h1
                    className={isDarkMode ? 'shimmer-edit' : 'shimmer-edit-light'}
                    style={{
                      fontSize: 22,
                      fontWeight: 900,
              ...
              <div style={{ display: 'flex', gap: 8, paddingBottom: 4 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: saving ? 'rgba(56,189,248,0.05)' : 'rgba(56,189,248,0.12)',
                    color: saving ? t.textSecondary : '#38bdf8',
                    fontSize: 12,
                    fontWeight: 700,
                    cursor: saving ? 'not-allowed' : 'pointer',
                    boxShadow: saving ? 'none' : '0 0 20px rgba(56,189,248,0.12)',
                    fontFamily: 'inherit',
                    transition: 'all .15s',
                  }}
                >
                  ...
                  <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                    <button
                      ...
                      style={{
                        ...
                        fontSize: 11,
                        fontWeight: 700,
                        cursor: emailAction ? 'not-allowed' : 'pointer',
                      }}
                    >
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10, paddingTop: 4 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    cursor: saving ? 'not-allowed' : 'pointer',
                    boxShadow: saving ? 'none' : '0 0 24px rgba(56,189,248,0.12)',
                    fontFamily: 'inherit',
                    transition: 'all .15s',
                  }}
                >
