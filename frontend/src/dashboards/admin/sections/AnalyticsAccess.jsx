...
import { BarChartCard, DistributionCard, TrendCard } from './analytics/AnalyticsVisuals';
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {forecast ? (
          <MetricCard
            ...
            value={
              forecast.summary?.completionRate == null ? '—' : `${forecast.summary.completionRate}%`
            }
    ...
    <div className="space-y-5">
      {metricGrid(
        <>
          <MetricCard
            ...
            helper="Current non-deleted account population."
            isDarkMode={isDarkMode}
          />
          <MetricCard
            icon={CheckCircle2}
            ...
            helper="Accounts currently in active state."
            isDarkMode={isDarkMode}
          />
          <MetricCard
            icon={Clock3}
            ...
            helper="Accounts currently pending activation."
            isDarkMode={isDarkMode}
          />
          <MetricCard
            icon={Activity}
            ...
            helper={`${summary.contributionEvents ?? 0} aggregate operational events in range.`}
            isDarkMode={isDarkMode}
          />
        </>
      )}
      ...
      <section className="grid gap-5 xl:grid-cols-2">
        <DistributionCard
          ...
          description="Current account state without names, emails, or contact data."
          rows={entriesByCount(payload.statusCounts)}
          isDarkMode={isDarkMode}
        />
        <DistributionCard
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1.45fr)_minmax(20rem,0.75fr)]">
        <TrendCard
          ...
          description="Aggregate forecast and review audit activity; this is not an employee ranking."
          rows={trend}
        ...
        <BarChartCard
          ...
          description="Tracked operational events by action."
      ...
      {metricGrid(
        <>
          <MetricCard
            ...
            helper="Enabled operational models reporting READY."
            isDarkMode={isDarkMode}
          />
          <MetricCard
            icon={Clock3}
            label="Current Forecast Cycle"
            value={summary.currentForecastCycle || '—'}
            helper="Required source cycle across operational models."
            isDarkMode={isDarkMode}
          />
          <MetricCard
            icon={BarChart3}
            ...
            helper="Models with a published current package."
            isDarkMode={isDarkMode}
          />
          <MetricCard
            icon={Activity}
            ...
            helper="Derived from current dynamic wave-model pipeline states."
            isDarkMode={isDarkMode}
          />
        </>
      )}
              ...
              rows.map((row, rowIndex) => (
                <tr key={rowIndex}>
                  {row.map((cell, cellIndex) => (
                    <td key={cellIndex} className="whitespace-nowrap px-4 py-3 font-semibold">
                      {cell}
                    </td>
                  ))}
                </tr>
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-5 p-4 sm:p-6">
      ...
      {!payload && !state.error ? (
        ...
        <OverviewPanel payload={payload} isDarkMode={isDarkMode} />
      ) : activeSection === 'forecast' ? (
        <ForecastPanel payload={payload} isDarkMode={isDarkMode} />
      ) : activeSection === 'public' ? (
        <PublicReachPanel payload={payload} isDarkMode={isDarkMode} />
      ) : activeSection === 'users' ? (
