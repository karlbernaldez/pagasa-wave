...
function getEmptyStateCopy({ hasFilters }) {
  ...
  return {
    title: 'No previous packages to show.',
    body: 'Older forecast packages will appear here after today’s primary package.',
  };
}
  ...
  return (
    <div className="min-h-full bg-transparent">
      <div className="mx-auto max-w-[1500px] space-y-5 p-4 sm:p-6">
        ...
        {!query.isLoading && !query.error && historicalPackages.length === 0 && (
          <StateCard isDarkMode={isDarkMode}>
        ...
        {!query.isLoading && !query.error && historicalPackages.length > 0 && (
          <div className="grid gap-4 xl:grid-cols-2">
            {historicalPackages.map((forecastPackage) => (
              <ForecastPackageCard
