...
export default function Home() {
  ...
  return (
    <main className={`relative min-h-screen overflow-hidden ${pageClass}`}>
      <section className="relative isolate flex min-h-[660px] items-center overflow-hidden bg-sky-950 bg-cover bg-center px-4 pb-40 pt-28 sm:px-6 lg:min-h-[760px] lg:bg-[center_right] lg:px-8" style={{ backgroundImage: `url(${HERO_IMAGE_URL})` }}>
        ...
        <div className={`absolute bottom-0 left-0 right-0 -z-10 h-48 bg-gradient-to-t ${isDark ? 'from-slate-950 via-slate-950/70' : 'from-slate-50 via-slate-50/75'} to-transparent`} aria-hidden="true" />
      ...
      <section className="relative z-10 mx-auto -mt-24 flex max-w-7xl flex-col gap-8 px-4 pb-20 sm:px-6 lg:px-8">
