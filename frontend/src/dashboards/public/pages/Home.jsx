...
import philippinesGeoJson from '@/data/ph.json';
...
const MAP_VIEWBOX = { width: 420, height: 560, padding: 18 };

const HOME_LIQUID_CSS = `
.wavelab-home .hero-bg-layer { transition: opacity 900ms ease, filter 900ms ease; }
.wavelab-home > header.sticky { position: fixed !important; inset: 0 0 auto 0 !important; z-index: 50 !important; background: rgba(255,255,255,0.012) !important; -webkit-backdrop-filter: blur(5px) saturate(165%) contrast(104%) brightness(1.02) !important; backdrop-filter: blur(5px) saturate(165%) contrast(104%) brightness(1.02) !important; border-color: rgba(255,255,255,0.38) !important; box-shadow: 0 10px 30px rgba(15,23,42,0.04), inset 0 1px 0 rgba(255,255,255,0.42), inset 0 -1px 0 rgba(255,255,255,0.16) !important; }
.wavelab-home.bg-slate-950 > header.sticky { background: rgba(2,6,23,0.020) !important; border-color: rgba(255,255,255,0.10) !important; }
.wavelab-home .hero-inner { min-height: clamp(760px, 86vh, 900px); align-items: center; padding-top: 11rem !important; padding-bottom: 7rem !important; }
.wavelab-home .hero-bottom-fade { position: absolute; left: 0; right: 0; bottom: 0; height: 9rem; pointer-events: none; background: linear-gradient(180deg, rgba(248,250,252,0), rgba(248,250,252,0.92) 78%, rgba(248,250,252,1)); }
.wavelab-home.bg-slate-950 .hero-bottom-fade { background: linear-gradient(180deg, rgba(2,6,23,0), rgba(2,6,23,0.86) 78%, rgba(2,6,23,1)); }
.wavelab-home .home-liquid { position: relative; isolation: isolate; overflow: hidden; background: rgba(255,255,255,0.30) !important; border-color: rgba(255,255,255,0.64) !important; -webkit-backdrop-filter: blur(16px) saturate(155%) contrast(104%) brightness(1.02) !important; backdrop-filter: blur(16px) saturate(155%) contrast(104%) brightness(1.02) !important; box-shadow: 0 28px 74px rgba(15,23,42,0.10), inset 0 1px 0 rgba(255,255,255,0.70), inset 0 -1px 0 rgba(255,255,255,0.20), inset 0 0 0 1px rgba(255,255,255,0.08) !important; }
.wavelab-home .home-liquid.is-dark { background: rgba(2,6,23,0.34) !important; border-color: rgba(255,255,255,0.14) !important; -webkit-backdrop-filter: blur(16px) saturate(165%) contrast(108%) brightness(1.04) !important; backdrop-filter: blur(16px) saturate(165%) contrast(108%) brightness(1.04) !important; box-shadow: 0 30px 84px rgba(0,0,0,0.30), inset 0 1px 0 rgba(255,255,255,0.16), inset 0 -1px 0 rgba(255,255,255,0.05), inset 0 0 0 1px rgba(255,255,255,0.035) !important; }
.wavelab-home .latest-forecast-card { background: rgba(255,255,255,0.012) !important; border-color: rgba(255,255,255,0.38) !important; -webkit-backdrop-filter: blur(20px) saturate(165%) contrast(104%) brightness(1.02) !important; backdrop-filter: blur(20px) saturate(165%) contrast(104%) brightness(1.02) !important; box-shadow: 0 10px 30px rgba(15,23,42,0.04), inset 0 1px 0 rgba(255,255,255,0.42), inset 0 -1px 0 rgba(255,255,255,0.16) !important; }
.wavelab-home.bg-slate-950 .latest-forecast-card { background: rgba(2,6,23,0.020) !important; border-color: rgba(255,255,255,0.10) !important; box-shadow: 0 10px 30px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.10), inset 0 -1px 0 rgba(255,255,255,0.04) !important; }
.wavelab-home .latest-forecast-card .home-liquid-row, .wavelab-home .latest-forecast-card .latest-forecast-actions { background: rgba(255,255,255,0.14) !important; border-color: rgba(255,255,255,0.34) !important; box-shadow: inset 0 1px 0 rgba(255,255,255,0.34), inset 0 -1px 0 rgba(255,255,255,0.08) !important; }
.wavelab-home.bg-slate-950 .latest-forecast-card .home-liquid-row, .wavelab-home.bg-slate-950 .latest-forecast-card .latest-forecast-actions { background: rgba(255,255,255,0.045) !important; border-color: rgba(255,255,255,0.10) !important; }
.wavelab-home .home-liquid::before { content: ''; position: absolute; inset: 0; z-index: 0; pointer-events: none; border-radius: inherit; background: radial-gradient(120% 85% at 50% -18%, rgba(255,255,255,0.18), transparent 42%), linear-gradient(180deg, rgba(255,255,255,0.055), transparent 38%, rgba(255,255,255,0.012)); opacity: 0.22; mix-blend-mode: screen; }
.wavelab-home .home-liquid.is-dark::before { opacity: 0.12; }
.wavelab-home .home-liquid > * { position: relative; z-index: 1; }
.wavelab-home .home-liquid-row { position: relative; overflow: hidden; background: rgba(255,255,255,0.26) !important; border-color: rgba(255,255,255,0.56) !important; -webkit-backdrop-filter: blur(12px) saturate(150%) contrast(104%) brightness(1.02) !important; backdrop-filter: blur(12px) saturate(150%) contrast(104%) brightness(1.02) !important; box-shadow: inset 0 1px 0 rgba(255,255,255,0.58), inset 0 -12px 22px rgba(15,23,42,0.025), inset 0 0 0 1px rgba(255,255,255,0.10) !important; }
.wavelab-home .home-liquid-row.is-dark { background: rgba(255,255,255,0.055) !important; border-color: rgba(255,255,255,0.13) !important; }
.wavelab-home .hero-ph-map { pointer-events: none; min-height: clamp(440px, 56vh, 660px); }
.wavelab-home .hero-ph-map::before { content: ''; position: absolute; inset: 5% -12% 0 -12%; border-radius: 999px; background: radial-gradient(circle at 50% 42%, rgba(255,255,255,0.42), rgba(14,165,233,0.12) 42%, transparent 70%); filter: blur(34px); opacity: 0.68; }
.wavelab-home.bg-slate-950 .hero-ph-map::before { background: radial-gradient(circle at 50% 42%, rgba(103,232,249,0.18), rgba(14,165,233,0.10) 42%, transparent 70%); opacity: 0.74; }
.wavelab-home .ph-map-shape { width: min(100%, 430px); height: clamp(420px, 54vh, 650px); margin-inline: auto; filter: drop-shadow(0 30px 38px rgba(15,23,42,0.18)) drop-shadow(0 0 18px rgba(255,255,255,0.42)); opacity: 0.96; }
.wavelab-home.bg-slate-950 .ph-map-shape { filter: drop-shadow(0 32px 42px rgba(0,0,0,0.38)) drop-shadow(0 0 22px rgba(103,232,249,0.18)); opacity: 0.94; }
.wavelab-home .ph-map-path { transition: opacity 300ms ease; }
.wavelab-home .ph-map-path:hover { opacity: 1; }
.wavelab-home .solid-blue, .wavelab-home .solid-blue:hover, .wavelab-home .solid-blue:focus, .wavelab-home .bg-blue-700 { background: #1d4ed8 !important; color: #fff !important; border-color: transparent !important; -webkit-backdrop-filter: none !important; backdrop-filter: none !important; }
.wavelab-home .solid-blue:hover { background: #1e40af !important; }
.wavelab-home .secondary-action { background: rgba(255,255,255,0.40) !important; color: #1d4ed8 !important; border-color: rgba(147,197,253,0.72) !important; }
.wavelab-home .secondary-action.is-dark { background: rgba(255,255,255,0.055) !important; color: #cffafe !important; border-color: rgba(255,255,255,0.16) !important; }
...
@media (max-width: 1023px) { .wavelab-home .hero-inner { min-height: auto; padding-top: 8.5rem !important; padding-bottom: 4rem !important; } .wavelab-home .hero-ph-map { min-height: 360px; } .wavelab-home .ph-map-shape { height: 360px; } }
`;
...
function parsePublicDate(value) {
  ...
  if (match) return new Date(`${match[1]}-${String(match[2]).padStart(2, '0')}-${String(match[3]).padStart(2, '0')}T00:00:00+08:00`);
...
function extractCoordinateRings(geometry) {
  if (!geometry) return [];
...
function getGeoBounds(features) {
  ...
  features.forEach((feature) => extractCoordinateRings(feature.geometry).forEach((ring) => ring.forEach(([lon, lat]) => {
...
function geoJsonToSvgPaths(geoJson) {
  ...
  return features.flatMap((feature, featureIndex) => extractCoordinateRings(feature.geometry).map((ring, ringIndex) => ({ id: `${featureIndex}-${ringIndex}`, d: ringToSvgPath(ring, bounds) })));
}
    ...
    <header className={cx('sticky top-0 z-40 border-b shadow-sm backdrop-blur-2xl transition-colors duration-300', isDarkMode ? 'border-white/10 bg-slate-950/[0.84]' : 'border-white/60 bg-white/[0.88]')}>
      <nav className="mx-auto flex min-h-20 max-w-[1500px] items-center justify-between gap-5 px-4 sm:px-6 lg:px-8" aria-label="Wavelab navigation">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <div className={cx('hidden items-center gap-3 rounded-2xl border px-4 py-2.5 text-right xl:flex', isDarkMode ? 'border-white/10 bg-white/[0.06]' : 'border-blue-100 bg-blue-50/70')}><Clock size={18} className={isDarkMode ? 'text-cyan-100' : 'text-blue-700'} aria-hidden="true" /><div><p className={cx('text-[11px] font-black uppercase tracking-wide', isDarkMode ? 'text-slate-300' : 'text-slate-500')}>Current time</p><p className={cx('text-sm font-black', isDarkMode ? 'text-cyan-100' : 'text-blue-700')}>{formatCurrentTime(currentTime)}</p></div></div>
...
function HeroPhilippinesMap({ isDarkMode }) {
  const paths = useMemo(() => geoJsonToSvgPaths(philippinesGeoJson), []);
  return <aside className="hero-ph-map relative hidden items-center justify-center lg:flex" aria-label="Liquid glass map of the Philippines"><svg className="ph-map-shape relative z-10" viewBox={`0 0 ${MAP_VIEWBOX.width} ${MAP_VIEWBOX.height}`} role="img" aria-label="Philippines map rendered from local GeoJSON"><defs><linearGradient id="phGlassFill" x1="0" x2="1" y1="0" y2="1"><stop offset="0%" stopColor={isDarkMode ? '#ecfeff' : '#ffffff'} stopOpacity="0.62" /><stop offset="44%" stopColor={isDarkMode ? '#bae6fd' : '#dbeafe'} stopOpacity="0.34" /><stop offset="100%" stopColor={isDarkMode ? '#22d3ee' : '#38bdf8'} stopOpacity="0.44" /></linearGradient><linearGradient id="phGlassStroke" x1="0" x2="1" y1="0" y2="1"><stop offset="0%" stopColor="#ffffff" stopOpacity="0.94" /><stop offset="52%" stopColor={isDarkMode ? '#67e8f9' : '#7dd3fc'} stopOpacity="0.86" /><stop offset="100%" stopColor={isDarkMode ? '#e0f2fe' : '#2563eb'} stopOpacity="0.60" /></linearGradient><filter id="phGlassDepth" x="-40%" y="-40%" width="180%" height="180%"><feDropShadow dx="0" dy="13" stdDeviation="9" floodColor={isDarkMode ? '#000000' : '#0f172a'} floodOpacity={isDarkMode ? '0.38' : '0.18'} /><feDropShadow dx="0" dy="0" stdDeviation="5" floodColor={isDarkMode ? '#67e8f9' : '#ffffff'} floodOpacity="0.42" /></filter></defs><g filter="url(#phGlassDepth)">{paths.length ? paths.map((path) => <path key={path.id} className="ph-map-path" d={path.d} fill="url(#phGlassFill)" stroke="url(#phGlassStroke)" strokeWidth="1.55" vectorEffect="non-scaling-stroke" />) : null}</g><g opacity="0.26" fill="none" stroke={isDarkMode ? '#cffafe' : '#ffffff'} strokeWidth="1.2"><path d="M92 150c62-26 142-25 206 4" /><path d="M80 274c82-28 174-24 242 8" /><path d="M102 408c62-20 136-16 190 8" /></g></svg></aside>;
}
