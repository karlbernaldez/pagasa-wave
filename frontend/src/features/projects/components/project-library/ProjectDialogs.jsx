...
import { AlertTriangle, Check, Copy, Pencil, Share2, Trash2, XCircle } from "lucide-react";
import { Dialog, DialogActions, DialogIcon } from "./Dialog";
...
export function ShareDialog({ project, isDark, onClose }) {
  ...
  return (
    <Dialog isDark={isDark} onBackdrop={onClose}>
      ...
      <div className={cn("flex items-center gap-2 rounded-xl border px-3 py-2.5 mb-5", isDark ? "bg-slate-800 border-slate-700" : "bg-slate-50 border-slate-200")}>
