  ...
  return (
    <section className={`relative min-h-screen flex items-center justify-center overflow-hidden transition-all duration-700 ${
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Compass */}
        <div className={`absolute top-20 left-16 transition-colors duration-700 ${
          isDark ? 'text-blue-400/20' : 'text-blue-500/20'
        }`} 
        ...
        <div className={`absolute top-32 right-20 transition-colors duration-700 ${
          isDark ? 'text-cyan-400/20' : 'text-cyan-500/20'
        }`}
        ...
        {/* Navigation */}
        <div className={`absolute bottom-40 left-24 transition-colors duration-700 ${
          isDark ? 'text-purple-400/20' : 'text-purple-500/20'
        }`}
        ...
        {/* Activity */}
        <div className={`absolute bottom-24 right-16 transition-colors duration-700 ${
          isDark ? 'text-pink-400/20' : 'text-pink-500/20'
        }`}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            {/* Status Badge */}
            <div className={`inline-flex items-center gap-3 px-6 py-3 rounded-full text-sm font-semibold backdrop-blur-sm transition-all duration-500 hover:scale-105 ${
              isDark 
            ...
            <div className="space-y-4">
              <h1 className={`text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight transition-colors duration-700 ${
              ...
              <p className={`text-lg sm:text-xl lg:text-2xl leading-relaxed max-w-2xl transition-colors duration-700 ${
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button className={`group flex items-center justify-center gap-3 font-semibold px-8 py-4 rounded-2xl border-2 transition-all duration-300 hover:scale-105 ${
                isDark 
            ...
            {/* Stats */}
            <div className={`grid grid-cols-3 gap-8 pt-8 border-t transition-colors duration-700 ${
              isDark ? 'border-slate-700/50' : 'border-slate-200'
            }`}>
              <div className="text-center lg:text-left">
                <div className={`text-3xl sm:text-4xl font-black transition-colors duration-700 ${
                  isDark ? 'text-white' : 'text-slate-900'
                }`}>
                  24/7
                </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className={`group relative w-full max-w-md p-8 rounded-3xl backdrop-blur-xl border transition-all duration-500 hover:scale-105 hover:-translate-y-2 ${
              isDark 
              ...
              <div className="text-center mb-6">
                <div className={`flex items-center justify-center gap-2 mb-2 transition-colors duration-700 ${
              ...
              <div className="text-center mb-8">
                <div className="relative">
                  <div className={`text-6xl font-black mb-2 transition-colors duration-700 ${
                    isDark ? 'text-white' : 'text-slate-900'
                  }`}>
                    2.8m
                  </div>
                  <div className="absolute -top-2 -right-2">
                    <Waves className={`w-12 h-12 transition-colors duration-700 ${
                      isDark ? 'text-blue-400' : 'text-blue-500'
                    }`} style={{ animation: 'bounce 2s infinite' }} />
                  </div>
                </div>
                <div className={`text-lg font-medium transition-colors duration-700 ${
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className={`text-center p-4 rounded-2xl transition-all duration-300 ${
                  ...
                  <TrendingUp className={`w-6 h-6 mx-auto mb-2 transition-colors duration-700 ${
                ...
                <div className={`text-center p-4 rounded-2xl transition-all duration-300 ${
                  ...
                  <Compass className={`w-6 h-6 mx-auto mb-2 transition-colors duration-700 ${
                ...
                <div className={`text-center p-4 rounded-2xl transition-all duration-300 ${
                  ...
                  <Wind className={`w-6 h-6 mx-auto mb-2 transition-colors duration-700 ${
                ...
                <div className={`text-center p-4 rounded-2xl transition-all duration-300 ${
                  ...
                  <Eye className={`w-6 h-6 mx-auto mb-2 transition-colors duration-700 ${
              ...
              <div className={`p-4 rounded-2xl transition-all duration-300 ${
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <BarChart3 className={`w-4 h-4 transition-colors duration-700 ${
                    isDark ? 'text-slate-400' : 'text-slate-500'
                  }`} />
                </div>
                  ...
                  {[2.1, 2.8, 3.2, 2.9, 2.3, 2.6, 3.1, 3.4].map((height, index) => (
                    <div
                      ...
                      className={`flex-1 rounded-t transition-all duration-500 hover:opacity-80 ${
                        isDark ? 'bg-gradient-to-t from-blue-500 to-cyan-400' : 'bg-gradient-to-t from-blue-500 to-cyan-500'
                      }`}
                      style={{ 
                        height: `${(height / 4) * 100}%`,
              ...
              <div className={`absolute inset-0 rounded-3xl transition-opacity duration-500 opacity-0 group-hover:opacity-100 ${
                isDark ? 'shadow-2xl shadow-blue-500/20' : 'shadow-2xl shadow-blue-500/10'
              }`} />
            </div>
          </div>
        </div>
